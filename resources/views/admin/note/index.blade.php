                    ...
                    <div class="col-md-12">
                        <div class="overview-wrap">
                            ...
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                <a type="button" href="{{ route('add_datesheet') }}"
                                    class="au-btn au-btn-icon au-btn--blue"><i class="zmdi zmdi-plus"></i> Create
                                    datesheets</a>
                                ...
                                <tr>
                                    ...
                                    @else
                                        <td class="d-flex">
                                            ...
                                            <a href="{{ route('delete_slips_marks', $slip->id) }}"
                                                class="btn btn-danger ml-2" role="button" aria-pressed="true">Delete</a>
                                            <a href="{{ route('update_slips_marks', $slip->id) }}" class="btn btn-info ml-2"
