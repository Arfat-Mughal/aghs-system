                    ...
                    <div class="col-md-12">
                        <div class="overview-wrap">
                            ...
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                <button type="button" class="au-btn au-btn-icon au-btn--blue" data-toggle="modal" data-target="#createNoteModal">
                        ...
                        <tbody>
                            @foreach ($notes as $note)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a href="{{route('notes.view',$note->id)}}" target="_black" class="btn btn-danger">
                                            PRINT
                                        </a>
