                ...
                <div class="ftco-footer-widget mb-5">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">0321-4960275, 0321-4969849, 042-37172500</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@aghslahore.pk</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
{{--                        <a class="blog-img mr-4" style="background-image: url({{asset('web_assets/images/image_1.jpg')}});"></a>--}}
{{--                        <div class="text">--}}
...
{{--                        <a class="blog-img mr-4" style="background-image: url({{asset('web_assets/images/image_2.jpg')}});"></a>--}}
{{--                        <div class="text">--}}
{{--                            <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>--}}
{{--                            <div class="meta">--}}
{{--                                <div><a href="#"><span class="icon-calendar"></span> Dec 25, 2018</a></div>--}}
