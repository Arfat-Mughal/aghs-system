            ...
            <div class="col-lg-12 d-block">
                <div class="row d-flex">
                    ...
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        ...
                        <span class="text">info@aghslahore.com</span>
                    </div>
                    <div class="col-md pr-4 d-flex topper align-items-center">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco_navbar ftco-navbar-light" id="ftco-navbar">
    <div class="container-fluid d-flex align-items-center">
        <div class="icon"><img src="{{asset('web_assets/images/logo_header.jpg')}}" alt="" width="90px" height="80px"></div>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item "><a href="{{route('notice')}}" class="nav-link pl-0">Notice</a></li>
