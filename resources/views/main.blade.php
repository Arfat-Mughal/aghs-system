...
@section('content')
    ...
    <section class="home-slider owl-carousel">
        <div class="slider-item" style="background-image:url({{asset('web_assets/images/bd_new1.jpg')}});">
        ...
        <div class="slider-item" style="background-image:url({{asset('web_assets/images/bd_22.jpg')}});">
            {{--            <div class="overlay"></div>--}}
            {{--            <div class="container">--}}
            {{--                <div class="row no-gutters slider-text align-items-center justify-content-center"--}}
            {{--                     data-scrollax-parent="true">--}}
            ...
            {{--            </div>--}}
                ...
                <div class="slider-item" style="background-image:url({{asset('web_assets/images/image_3.jpg')}});">
{{--                    <div class="overlay"></div>--}}
{{--                    <div class="container">--}}
{{--                        <div class="row no-gutters slider-text align-items-center justify-content-center"--}}
{{--                             data-scrollax-parent="true">--}}
{{--                            <div class="col-md-8 text-center ftco-animate">--}}
{{--                                <h1 class="mb-4">Need<span> For Your Child</span></h1>--}}
{{--                                <p><a href="#" class="btn btn-secondary px-4 py-3 mt-3">Read More</a></p>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
                </div>
        <div class="slider-item" style="background-image:url({{asset('web_assets/images/course-1.jpg')}});">
{{--                    <div class="overlay"></div>--}}
{{--                    <div class="container">--}}
{{--                        <div class="row no-gutters slider-text align-items-center justify-content-center"--}}
{{--                             data-scrollax-parent="true">--}}
